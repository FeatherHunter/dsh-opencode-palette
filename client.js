// dsh-opencode-palette v1.7.2 — 动态版（构建产物，勿手改）
...
const FONT_PROBE_TEXT = 'mmmmwwwwMMMM'
const FONT_PROBE_ABSENT = '__dsh_palette_absent_font__'
const FONT_PROBE_SIZE = 64
...
function createFontAvailability(resolveDoc, bundledFonts) {
